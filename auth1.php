...
$dbh = mysqli_connect('localhost','root','') or die(mysqli_error());
	mysqli_select_db($dbh,'book') or die(mysqli_error($dbh));
if(isset($_POST['e_mail'])){
   $e_mail=$_POST['e_mail'];
   $e_pass=$_POST['e_pass'];
   
   $sql="select * from members where e_mail='".$e_mail."' AND e_pass='".$e_pass."' 
   limit 1";
  ...
  <header id="main-header">
	...
	<hr>
	 ...
	 <label>USERMAIL:</label>
      ...
      <a href="register.php">MEMBERS REGISTRATION</a>
     </div>
  </body>
  </html>